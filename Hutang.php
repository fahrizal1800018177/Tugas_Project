...
$data = file_get_contents('hutang.json');
...
<html lang="en">
  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        ...
        <a class="nav-item nav-link active" href="#">Hutang<span class="sr-only">(current)</span></a>
        </div>
    </div>
    </nav>
...
<div class = "container">
  ...
  <div class = "row mt-3" >
    <div class = "col">
        ...
        <h2><a href = "#"> Hutang </a></h2>
      
      </div>

    <div class = "col" >
        
        <h2><a href = "#"> Pembayaran </a></h2>
...

{
    "hutang":[
...

        {
            "kategori" : "Pembayaran",
            "jumlah" : 40000,
            "keterangan" : "Jumlah Yang Anda Bayarkan",
            "jadwal" : "Tidak Selalu",
            "gambar" : "keluar.png"
        }
